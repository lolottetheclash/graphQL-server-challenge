...
const schema = buildSchema(`
    type Query {
        ...
        coursesResearch(text: String!) : [Course]
    },
    type Mutation {
...
const lookForTitle = function ({ text }) {
  const correspondingCourses = coursesData.filter(course =>
    course.title.includes(text)
  );
...
const addCourse = function ({ id, title, author, description, topic, url }) {
  const newCourse = { id, title, author, description, topic, url };
